# Independent Go verifier (v1.0 M0 plus codec/principal M1 slices)
...
enums and creation/update ordering. These are partial M1 semantic families, not completion of M1.
