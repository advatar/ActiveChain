...
use activechain_protocol_types::{
    ...
    ChainId, CryptoSuiteId, DataSelector, Digest384, FreezeState, HolderBinding, Object,
    ObjectFields, ObjectFlags, ObjectId, ObjectOwner, ObjectVersionRef, Principal, PrincipalId,
    PrincipalKind, ProtocolSignature, RateLimit, RecoveryRequest, ResourceSelector,
};
...
mod tests {
    use super::{
        render_apl_truth_table, render_apl_v1, render_authority_v1, render_devnet_block_v1,
        render_nonce_model_table, render_object_model_table, render_object_transition_v1,
        render_object_vm_model_table, render_object_vm_v1, render_principal_v1,
