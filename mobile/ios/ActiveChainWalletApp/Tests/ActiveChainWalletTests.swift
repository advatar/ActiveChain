...
final class ActiveChainWalletTests: XCTestCase {
    ...
    func testFaucetRequestUsesPlainBoundedCanonicalRPCShape() throws {
        ...
        XCTAssertEqual(Array(frame[4..<8]), [0x01, 0x07, 0, 4])
    ...
    func testOwnerCoinPageDecoderRejectsWrongRecordKind() throws {
        ...
        var envelope = Data([0x01, 0x0a, 0, 5, UInt8(body.count)])
    ...
    func testOwnerCoinPageDecoderAcceptsProofBearingBodiesLargerThanStatus() throws {
        ...
        var envelope = Data([0x01, 0x0a, 0, 5])
    ...
    private func makeStatusResponse(
        ...
        var envelope = Data([0x01, 0x0a, 0, 5, 0x91, 0x01])
        envelope.append(body)
        return envelope
    }
    ...
    func testMalformedOrDuplicateNetworksAreRefused() throws {
        ...
        let shortGenesis = WalletNetwork(
            ...
            protocolRevision: 1, schemaRevision: 5,
