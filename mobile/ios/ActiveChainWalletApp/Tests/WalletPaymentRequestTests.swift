...
final class WalletPaymentRequestTests: XCTestCase {
    ...
    func testSigningPayloadBindsEveryHumanVisibleField() throws {
        ...
        let memoChanged = WalletPaymentRequestV1.Body(
            version: base.version, chainID: base.chainID, genesis: base.genesis,
            recipient: base.recipient, amountAtomicUnits: base.amountAtomicUnits,
            reference: base.reference, memo: "B", expiresAtHeight: base.expiresAtHeight,
            publicKey: base.publicKey
        )
        XCTAssertNotEqual(try memoChanged.signingPayload(), original)
        let amountChanged = WalletPaymentRequestV1.Body(
            version: base.version, chainID: base.chainID, genesis: base.genesis,
            recipient: base.recipient, amountAtomicUnits: "2", reference: base.reference,
            memo: base.memo, expiresAtHeight: base.expiresAtHeight, publicKey: base.publicKey
        )
