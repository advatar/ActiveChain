...
Kani 0.67 checks six harnesses over production `protocol-types` code. Three
...
by Kani. Ordinary tests exercise that composed SHAKE256 path; the companion
