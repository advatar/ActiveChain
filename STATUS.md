...
- [ ] Add canonical application-layer compute escrow and assurance-attestation types and vectors.
- [ ] Reserve a future bounded compute verifier interface without activating compute semantics in
  v1 consensus.
