...
for binary in validator-node genesis-tool cash-genesis-tool activechain-rpc-node activechain-rpc-ingest activechain-rpc-bootstrap activechain-rpc-probe activechain-transfer-spool activechain-telemetry-anchor-gateway actum-work-proof-verifier actum-work-proof-json-verifier actum-work-proof-api actum-work-proof-trust-bootstrap actum-work-proof-trust-transition actum-work-proof-testnet-trust-bootstrap actum-work-prover actum-work-qualification-source actum-work-delivery-api; do
