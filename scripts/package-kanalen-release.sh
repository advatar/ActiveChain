...
for binary in validator-node genesis-tool cash-genesis-tool activechain-rpc-node activechain-rpc-ingest activechain-rpc-bootstrap activechain-rpc-probe activechain-transfer-spool activechain-telemetry-anchor-gateway actum-work-proof-verifier actum-work-proof-json-verifier actum-work-proof-api actum-work-proof-trust-bootstrap; do
