...
mod tests {
    ...
    fn billboard_image_ids_match_the_published_vector() {
        assert_eq!(
            ...
            [
                1479160789, 4061568009, 3373791349, 2473479925, 1135536606, 771393440, 3695444580,
                2872423700
            ]
        );
        assert_eq!(
            ...
            [
                1600984179, 2339290501, 2806848752, 733905340, 3854509388, 1292605270, 2837445947,
                1149651860
            ]
        );
