...
mod tests {
    ...
    fn apple_anchor_boundary_matches_canonical_vector_and_rpc_types() {
        ...
        assert_eq!(
            request,
            decode_hex(
                "010700044d034b00c6000146256d6164656d61726b2e65787465726e616c2d616e63686f722e73746174656d656e742e76311111111111111111111111111111111111111111111111111111111111111111"
            )
        );
        ...
        assert_eq!(
            request,
            decode_hex(
                "01070004310428a93d59175490cae50f5bb2dfaaee27084b6bb27ffb92df4bfa8683b213af7ffabdd29156f6e7ab3d55e90d4bb31a8c"
            )
        );
    }
